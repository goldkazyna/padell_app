...
/// Тело чата турнира (лента + поле ввода) без Scaffold/AppBar.
/// Используется и в полноэкранном [TournamentChatScreen], и как вкладка «Чат»
/// в админ-панели турнира.
class TournamentChatView extends StatefulWidget {
  final int tournamentId;
  final TournamentChat chat;

  const TournamentChatView({
    super.key,
  ...
  @override
  State<TournamentChatView> createState() => _TournamentChatViewState();
}

class _TournamentChatViewState extends State<TournamentChatView>
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    final bubble = ChatMessageBubble(
                      message: m,
                      onLongPress:
                          canDelete ? () => _confirmDelete(m.id, l10n) : null,
                    );
