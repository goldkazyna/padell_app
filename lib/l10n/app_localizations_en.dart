...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get tournamentInfoEscaleraBody =>
      'A ladder of courts: the strongest players are at the top, those who keep losing move to the bottom. Each round the four players on a court play three short matches, after which the best one moves up a court and the worst moves down.\n\nHow it works. The number of players is exactly courts × 4. The starting arrangement follows rating: the four strongest on court 1, the next four on court 2 and so on. Three matches are played on each court so that everyone partners everyone: 1+4 vs 2+3, then 1+3 vs 2+4, then 1+2 vs 3+4.\n\nMovement. Places are decided by total points from the three matches. First moves up a court, fourth moves down, the two in the middle stay. There is nowhere to go above the top court or below the bottom one, so only one player moves there.\n\nScoring. The organiser decides the format of a short match — any score is accepted and a draw is allowed.\n\nStandings. The ranking metric is chosen when the tournament is created. By points — the sum scored across all short matches. By position points — the format\'s native ranking: the court number is built into the position, so climbing beats piling up points at the bottom. Ties are broken by matches won, then head-to-head, then rating at the start.\n\nRating. Awarded for every short match by the usual Elo formula, so an evening brings many matches and rating can swing noticeably.\n\nWho it suits. Players who want opponents of their own level: the ladder sorts everyone by strength within a couple of rounds.';
  ...
  @override
  String get notifyBookingReminders => 'Booking reminders';

  @override
  String get notifyBookingRemindersDesc =>
      'Push a day, 2 hours and an hour before your court booking';
  ...
  @override
  String get aiAnalysisButton => 'AI review';

  @override
  String get aiAnalysisTitle => 'Tournament review';

  @override
  String get aiAnalysisLoading => 'AI is analyzing your performance…';

  @override
  String get aiAnalysisErrorTitle => 'Couldn\'t generate the review';

  @override
  String get aiAnalysisRetry => 'Retry';

  @override
  String get aiAnalysisFactorsTitle => 'What affected your rating';

  @override
  String get aiAnalysisBestMatch => 'Best match';

  @override
  String get aiAnalysisWorstMatch => 'Weakest match';

  @override
  String get aiAnalysisTipsTitle => 'Tips to improve';

  @override
  String get aiAnalysisFootnote => 'Generated by AI based on your matches';

  @override
  String get aiMatchesTitle => 'Match-by-match';

  @override
  String get aiYourPair => 'Your pair';

  @override
  String get aiOpponents => 'Opponents';

  @override
  String get aiWinChance => 'Win chance';

  @override
  String get aiResultWin => 'Win';

  @override
  String get aiResultLoss => 'Loss';

  @override
  String get aiMatchNoEffect => 'Match didn\'t affect rating (0:0)';

  @override
  String get aiMatchWinStrong => 'Beat a stronger pair — maximum points';

  @override
  String get aiMatchWinExpected => 'Expected win — small gain';

  @override
  String get aiMatchLossFavorite => 'Lost to the favorite — small loss';

  @override
  String get aiMatchLossWeak => 'Lost to a weaker pair — bigger loss';

  @override
  String get servicesTitle => 'Services';

  @override
  String get serviceBooking => 'Booking';

  @override
  String get serviceClubs => 'Clubs';

  @override
  String get serviceCommunity => 'Community';

  @override
  String get serviceShop => 'Shop';

  @override
  String get serviceCreateGame => 'Create game';

  @override
  String get serviceGames => 'Games';

  @override
  String get serviceClubCards => 'Club cards';
  ...
  @override
  String get clubCardsEmptyTitle => 'You don\'t have club cards yet';

  @override
  String get clubCardsEmptyHint =>
      'A card appears here automatically once a club issues it to your phone number';

  @override
  String get clubCardsActive => 'Active';

  @override
  String get clubCardsArchive => 'Archive';

  @override
  String get clubCardsNoActive => 'No active cards';

  @override
  String get clubCardsArchiveEmpty => 'Archive is empty';
  ...
  String clubCardRemaining(int balance, int initial) {
    return '$balance of $initial left';
  }
  ...
  @override
  String get clubCardUnlimited => 'Unlimited';

  @override
  String get clubCardExpired => 'Expired';

  @override
  String get clubCardValidUntilShort => 'until';

  @override
  String get clubCardKindVisits => 'Sessions';

  @override
  String get clubCardKindTrainer => 'Trainer';

  @override
  String get clubCardKindDiscountCourt => 'Court discount';

  @override
  String get clubCardKindDiscountTrainer => 'Trainer discount';

  @override
  String get clubCardCodeLabel => 'Card code';
  ...
  @override
  String get clubCardHistoryEmpty => 'No operations yet';

  @override
  String get clubCardCharge => 'Charge';

  @override
  String get clubCardChargeBooking => 'Charge for booking';

  @override
  String get clubCardBookingsButton => 'Bookings by card';

  @override
  String get clubCardBookingsEmpty => 'No upcoming bookings for this card';

  @override
  String clubCardBookingCancelHint(int hours) {
    return 'Cancel no later than $hours h before start';
  }
  ...
  @override
  String get bookingTomorrow => 'tomorrow';
