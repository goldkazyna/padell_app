...
abstract class AppLocalizations {
  ...
  ///
  /// In ru, this message translates to:
  /// **'Американо для любого числа игроков с очередью отдыха. Каждый раунд часть игроков выходит на корты, остальные отдыхают — отдых распределяется по очереди и поровну, никто не сидит лишнего.\n\nПары и соперники подбираются по готовым сеткам так, чтобы вы сыграли с как можно большим числом разных партнёров без повторов, а встречи с соперниками были равномерными. Зачёт индивидуальный, итоговое место — по среднему за матч.\n\nКак собрать хорошую игру:\n• Кортов берите примерно «игроки ÷ 4» — чтобы отдыхающих было меньше. Например: 8 человек — 2 корта, 12 — 3 корта.\n• 9–11 человек на 2 кортах или 13–15 на 3 — нормально, просто 1–3 игрока отдыхают каждый раунд.\n• Сколько раундов: чтобы каждый сыграл в паре со всеми по разу — это примерно «уникальных пар ÷ пар за раунд». Для 10 игроков на 2 кортах — 11 раундов, для 12 — до 16.\n• Не гонитесь за лишними раундами: когда свежие пары заканчиваются, начинаются повторы партнёров.\n\nЛучше всего работает на 8–18 игроках и 2–3 кортах — тогда сетка раздаёт пары идеально: каждый успевает поиграть со всеми и против всех.'**
