...
/// Live-экран турнира «Just Padel It».
...
class TournamentLiveJustPadelItScreen extends StatefulWidget {
  ...
  const TournamentLiveJustPadelItScreen({
    super.key,
  ...
  @override
  State<TournamentLiveJustPadelItScreen> createState() =>
      _TournamentLiveJustPadelItScreenState();
}

enum _KocTab { rounds, table }

class _TournamentLiveJustPadelItScreenState
    extends State<TournamentLiveJustPadelItScreen> {
  bool _loading = true;
  String? _error;
  ...
  /// Just Padel It с фиксированными парами — таблица показывается по парам.
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            // Round Robin: З · ПР · ±   |   Just Padel It: РП · % · ОЧКИ
            if (isRR) ...[
              SizedBox(
                width: 36,
                child: Text(
  ...
  /// Строка таблицы для парного Just Padel It: пара (2 игрока) + статы по JPI.
